    ...
    <header style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 40 }}>
          <a href="Grassfed Home.html" style={{ borderBottom: 'none', display: 'flex', alignItems: 'center' }}>
          ...
          <nav style={{ display: 'flex', gap: 28 }}>
            ...
            <a href="Pricing.html" style={{ color: 'var(--fg)', fontSize: 14, fontWeight: 500, opacity: 0.75, borderBottom: 'none' }}>Pricing</a>
            <a href="Grassfed Farm.html" style={{ color: 'var(--fg)', fontSize: 14, fontWeight: 500, opacity: 0.75, borderBottom: 'none' }}>For brokerages</a>
          </nav>
        </div>
